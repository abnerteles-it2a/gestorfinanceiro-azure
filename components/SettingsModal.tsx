                                ...
                                <FormSection title="Contas e Carteiras" description="Adicione suas contas bancárias, caixas em espécie ou carteiras de corretora.">
                                    <div className="bg-white dark:bg-slate-900/40 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                                        ...
                                        <form onSubmit={(e) => {
                                            ...
                                            <input value={newAcc.name} onChange={e=>setNewAcc({...newAcc, name: e.target.value})} placeholder="Nome (Ex: Principal)" className="h-11 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2 text-sm font-bold focus:ring-2 focus:ring-[#0D9488]/20 outline-none" required />
                                            <input value={newAcc.bank} onChange={e=>setNewAcc({...newAcc, bank: e.target.value})} placeholder="Banco (Ex: Nubank)" className="h-11 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2 text-sm font-bold focus:ring-2 focus:ring-[#0D9488]/20 outline-none" required />
                                ...
                                <FormSection title="Centros de Custo" description="Ideal para separar despesas Fixas de Variáveis ou projetos específicos.">
                                    <div className="bg-white dark:bg-slate-900/40 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                                        ...
                                        <form onSubmit={(e) => {
                                            ...
                                            <input value={newCC.name} onChange={e=>setNewCC({...newCC, name: e.target.value})} placeholder="Nome (Ex: Marketing, Infraestrutura...)" className="h-11 flex-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2 text-sm font-bold focus:ring-2 focus:ring-[#0D9488]/20 outline-none" required />
                                            <select value={newCC.scope} onChange={e=>setNewCC({...newCC, scope: e.target.value as any})} className="h-11 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2 text-sm font-black uppercase tracking-tight outline-none">
                                    ...
                                    <div className="lg:col-span-7 bg-white dark:bg-slate-900 rounded-4xl border border-slate-200 dark:border-slate-800 shadow-sm p-8">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-1">
                                                ...
                                                <input type="text" value={profName} onChange={e=>setProfName(e.target.value)} placeholder="Seu nome..." className="w-full h-11 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 text-sm font-bold focus:ring-2 focus:ring-[#0D9488]/20 outline-none" />
                                            </div>
                                            <div className="space-y-1">
                                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">CPF / CNPJ</label>
                                                <input type="text" value={profDoc} onChange={e=>setProfDoc(e.target.value)} placeholder="000.000.000-00" className="w-full h-11 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 text-sm font-bold focus:ring-2 focus:ring-[#0D9488]/20 outline-none" />
                                            </div>
